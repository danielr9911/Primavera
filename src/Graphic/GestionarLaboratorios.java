 ...
 * @author dsernae
 */
public class GestionarLaboratorios extends javax.swing.JFrame {
    static Connection conn = null;
    /**
     * Creates new form GestionarLaboratorios
     */
    public GestionarLaboratorios() {
        initComponents();
        setLocationRelativeTo(null);
        setResizable(false);
        setTitle("--PRIMAVERA--GESTIONAR LABORATORIOS--");
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/Laboratorios.png"))); // NOI18N
        ...
        tamañoText.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                tamañoTextActionPerformed(evt);
            }
        });
    ...
    private void modificarButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_modificarButtonActionPerformed
        Primavera.update("laboratorios", "nombre_lab", nombreText.getText(), "id_laboratorio", idText.getText());
        Primavera.update("laboratorios", "tamaño_lab", tamañoText.getText(), "id_laboratorio", idText.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GestionarLaboratorios.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GestionarLaboratorios().setVisible(true);
            }
        });
    }
