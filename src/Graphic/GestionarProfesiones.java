 ...
 * @author dsernae
 */
public class GestionarProfesiones extends javax.swing.JFrame {
    static Connection conn = null;
    /**
     * Creates new form GestionarProfesiones
     */
    public GestionarProfesiones() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/GestionarProfesiones.png"))); // NOI18N
    ...
    private void nombreTextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_nombreTextActionPerformed
        if (idText.getText().equals("")) {
            ...
            try {
                ResultSet result = Primavera.selectAllFrom("profesion", "id_profesion", idText.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GestionarProfesiones.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GestionarProfesiones().setVisible(true);
            }
        });
    }
